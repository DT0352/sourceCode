package com.itheima.pinda.user.config;

import java.util.List;
import com.itheima.pinda.user.feign.UserResolveApi;
import com.itheima.pinda.user.interceptor.ContextHandlerInterceptor;
import com.itheima.pinda.user.resolver.ContextArgumentResolver;
